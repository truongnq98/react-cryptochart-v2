...
var Angle = function (_Component) {
	...
	_createClass(Angle, [{
		...
		value: function render() {
			...
			var tempLine = isDefined(current) && isDefined(current.end) ? React.createElement(AngleComponent, { type: type,
				noHover: true,
			...
			return React.createElement(
				...
				trends.map(function (each, idx) {
					...
					return React.createElement(EachAngle, { key: idx,
...
Angle.propTypes = {
	...
	type: PropTypes.oneOf(["ANGLE", "RECTANGLE", "CIRCLE"]),
