	...
	_createClass(BollingerBandTooltip, [{
		...
		value: function renderSVG(moreProps) {
			var _props = this.props,
			    ...
			    interactiveMode = _props.interactiveMode;
			...
			var tooltipLabel = "BB(" + sourcePath + ", " + windowSize + ", " + multiplier + ", " + movingAverageType + ")" + (interactiveMode ? ": " : "");
			var tooltipValue = interactiveMode ? top + ", " + middle + ", " + bottom : "";
