	...
	_createClass(HoverTooltip, [{
		...
		value: function render() {
			return _react2.default.createElement(_GenericComponent2.default, {
				...
				drawOn: ["mousemove", "pan", "touchmove", "touchstart" /* , "mouseleave" */]
			});
		}
	}, {
		key: "renderSVG",
...
function _drawOnCanvas(ctx, props, context, pointer, height) {
	...
	if (props.isTouchStart || !props.isDetailMobile) {
...
function helper(props, moreProps, ctx) {
	...
	var isDetailMobile = props.isDetailMobile;
	...
	var pointWidth = isDetailMobile ? 1.5 : Math.abs(xScale(xAccessor((0, _utils.last)(plotData))) - xScale(xAccessor((0, _utils.first)(plotData)))) / (plotData.length - 1);
