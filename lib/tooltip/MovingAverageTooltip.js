	...
	_createClass(SingleMAToolTip, [{
		...
		value: function render() {
			var _props2 = this.props,
			    ...
			    interactiveMode = _props2.interactiveMode;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						interactiveMode ? this.props.value : ""
					)
				),
	...
	_createClass(MovingAverageTooltip, [{
		...
		value: function renderSVG(moreProps) {
			var _props3 = this.props,
			    displayValuesFor = _props3.displayValuesFor,
			    interactiveMode = _props3.interactiveMode;
...
MovingAverageTooltip.propTypes = {
	...
	interactiveMode: _propTypes2.default.bool
};
