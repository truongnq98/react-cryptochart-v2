...
var _EachAngle = require("./wrapper/EachAngle");

var _EachAngle2 = _interopRequireDefault(_EachAngle);
...
var Angle = function (_Component) {
	...
	_createClass(Angle, [{
		...
		value: function render() {
			...
			var tempLine = (0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.end) ? _react2.default.createElement(_Angle2.default, { type: type,
				noHover: true,
			...
			return _react2.default.createElement(
				...
				trends.map(function (each, idx) {
					...
					return _react2.default.createElement(_EachAngle2.default, { key: idx,
...
Angle.propTypes = {
	...
	type: _propTypes2.default.oneOf(["ANGLE", "RECTANGLE", "CIRCLE"]),
