...
var _EachPitchFork = require("./wrapper/EachPitchFork");

var _EachPitchFork2 = _interopRequireDefault(_EachPitchFork);
	...
	_createClass(PitchFork, [{
		...
		value: function handleDrawChannel(xyValue) {
			...
			if ((0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.startXY)) {
				...
				if ((0, _utils.isNotDefined)(current.finishXY)) {
					this.setState({
						current: {
		...
		value: function render() {
			...
			var tempChannel = (0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.endXY) ? _react2.default.createElement(_EachPitchFork2.default, _extends({
				type: type,
				interactive: false
			}, current, {
				appearance: appearance,
			...
			return _react2.default.createElement(
				...
				channels.map(function (each, idx) {
					...
					return _react2.default.createElement(_EachPitchFork2.default, _extends({
						key: idx,
						type: type,
