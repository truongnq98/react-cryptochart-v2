...
var _EachFreeLine = require("./wrapper/EachFreeLine");

var _EachFreeLine2 = _interopRequireDefault(_EachFreeLine);

var _FreeLine = require("./components/FreeLine");

var _FreeLine2 = _interopRequireDefault(_FreeLine);
...
var FreeLine = function (_Component) {
	...
	_createClass(FreeLine, [{
		...
		value: function handleDrawLine(xyValue) {
			...
			if ((0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.positionList.length > 0)) {
		...
		value: function handleStart(xyValue, moreProps, e) {
			...
			if ((0, _utils.isNotDefined)(current) || (0, _utils.isNotDefined)(current.positionList)) {
		...
		value: function handleEnd(xyValue, moreProps, e) {
			...
			if (this.mouseMoved && (0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.positionList.length > 100)) {
				var positionList = current.positionList;
				positionList.push(xyValue);
		...
		value: function render() {
			...
			var tempLine = (0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.positionList.length > 0) ? _react2.default.createElement(_FreeLine2.default, {
				noHover: true,
			...
			return _react2.default.createElement(
				...
				trends.map(function (each, idx) {
					...
					return _react2.default.createElement(_EachFreeLine2.default, { key: idx,
						ref: _this5.saveNodeType(idx),
						index: idx,
						type: each.type,
						selected: each.selected,
						positionList: (0, _utils2.getValueFromOverride)(override, idx, "positionList", each.positionList),
